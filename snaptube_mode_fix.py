...
# ==========================================
# 1. الأيقونة (سهم مجوف فقط - بدون نقطة)
# ==========================================
...
# ==========================================
# 3. MainActivity (كود نظيف وآمن من الأخطاء)
# ==========================================
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupHiddenBrowser() {
        ...
        // التمويه كآيفون للحصول على روابط مباشرة
        ...
        hiddenWebView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                // حقن كود JS بسيط جداً لتجنب أخطاء البناء
        ...
        // إضافة المتصفح للشاشة بحجم 1 بكسل
