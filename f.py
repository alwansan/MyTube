...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <TextView
        ...
        android:text="• انسخ رابط YouTube وادخله هنا\\n• يمكنك مشاركة الروابط مباشرة من YouTube إلى هذا التطبيق\\n• التحميل إلى مجلد التنزيلات"
...
# ==========================================
# 5. ملفات الموارد الأخرى
# ==========================================
strings_xml = """<?xml version="1.0" encoding="utf-8"?>
<resources>
    <string name="app_name">MyTube</string>
    <string name="permission_rationale">الصلاحيات مطلوبة لحفظ الفيديوهات</string>
</resources>
"""
...
def setup_project():
    ...
    # إنشاء ملفات الأيقونة الفارغة (يمكن استبدالها لاحقاً)
...
def git_operations():
    try:
        ...
        if not os.path.exists(".git"):
            ...
            subprocess.run(["git", "config", "user.name", "alwansan"], check=True)
        ...
        subprocess.run(["git", "remote", "add", "origin", repo_url], check=False)  # قد يكون موجوداً
        ...
        print("🔗 https://github.com/alwansan/MyTube")
